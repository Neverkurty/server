...
async def soft_delete_role_permission(
    ...
    # Find the relationship regardless of its deleted status
    ...
    # If already deleted, return success without doing anything
    if role_permission.is_deleted:
        return {"detail": "Role-permission relationship was already soft deleted"}
    ...
    return {"detail": "Role-permission relationship soft deleted successfully"}